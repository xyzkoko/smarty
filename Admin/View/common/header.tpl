...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<{$SCRIPT_NAME}>"><{$username}></a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="<{$SCRIPT_NAME}>?c=admin&m=logout"><i class="fa fa-sign-out fa-fw"></i> 注销</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <{foreach from=$menuList item=rows}>
                    <li>
                        <a href="<{$SCRIPT_NAME}>?c=<{$rows['c']}>&m=<{$rows['m']}>"><i class="fa <{$rows['icon']}> fa-fw"></i> <{$rows['name']}><{if isset($rows['child'])}><span class="fa arrow"></span><{/if}></a>
                        <{if isset($rows['child'])}>
                        <ul class="nav nav-second-level">
                            <{foreach from=$rows['child'] item=rows2}>
                            <li>
                                <a href="<{$SCRIPT_NAME}>?c=<{$rows2['c']}>&m=<{$rows2['m']}>"><{$rows2['name']}></a>
                            </li>
                            <{/foreach}>
                        </ul>
                        <{/if}>
